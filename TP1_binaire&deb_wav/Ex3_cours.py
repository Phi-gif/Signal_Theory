...
##fonction codant le signal v=s(t) en nombre binaire sur 8 bits (version automatique)
...
#Question b
## Fonction permettant de coder en binaire sur 8 bits non signés toutes les 44100 valeurs des deux signaux (stéréo)
