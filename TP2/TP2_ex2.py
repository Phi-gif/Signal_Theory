...
def signal(t):
    ...
    if sumcum_duree[4]<=t<=sumcum_duree[5]-interlude:
        ...
        return(0)                                       #mettre 0 ou autre chose ? crache sur mon ordi
        
#Création du tableau de données        
def remplissage_array_chanson(sig,t,recadrage):
...
data_chanson = remplissage_array_chanson(signal,int(sum(durees)),u)
